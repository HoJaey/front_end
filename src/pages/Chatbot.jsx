      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 16 }}>
        ...
        {loading && (
          <div style={{ display: 'flex', justifyContent: 'flex-start', marginBottom: 12 }}>
            <div style={{ padding: '12px 16px', borderRadius: 14, background: aiBubble, border: `1px solid ${aiBubbleBorder}`, fontSize: 14, color: loadingColor }}>분석 중...</div>
          </div>
        )}
        <div ref={bottom} />
      </div>
